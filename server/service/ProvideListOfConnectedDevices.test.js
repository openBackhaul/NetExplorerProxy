...
describe('provideListOfConnectedDevices', () => {
    const mockRequestUrl = 'http://localhost:4018/v1/provide-list-of-connected-devices';
    ...
    it('should call postRequestDataFromMWDI with correct arguments and return the result', async () => {
        ...
        requestHandler.postRequestDataFromOtherApp.mockResolvedValue(getMockResultData(expectedResult));
