"""Test 8: API: /v1/provide-ltp-equipment-mappings."""
...
class TestProvideLtpEquipmentMappings:
    """Test class for /v1/provide-ltp-equipment-mappings API."""

    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_returns_response_and_ltp_equipment_mappings_columns_exist(self):
        """Test that returns response and ltp_equipment_mappings columns exist."""
        test_file = __file__
        test_name = "test_returns_response_and_ltp_equipment_mappings_columns_exist"

        test_case = TEST_CASES["provideLtpEquipmentMappings"]
