"""Test 4: API: /v1/provide-air-interface-general-information-of-devices."""
...
class TestProvideAirInterfaceGeneralInformationOfDevices:
    """Test class for /v1/provide-air-interface-general-information-of-devices API."""

    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_returns_response_and_air_interface_general_info_columns_exist(self):
        """Test that returns response and air_interface_general_info columns exist."""
        test_file = __file__
        test_name = "test_returns_response_and_air_interface_general_info_columns_exist"

        test_case = TEST_CASES["provideAirInterfaceGeneralInformationOfDevices"]
