"""Test 2: API: /v1/provide-general-information-of-devices."""
...
class TestProvideGeneralInformationOfDevices:
    """Test class for /v1/provide-general-information-of-devices API."""
    ...
    async def test_returns_response_and_devices_general_info_columns_exist(self):
        ...
        test_case = TEST_CASES["provideGeneralInformationOfDevices"]
