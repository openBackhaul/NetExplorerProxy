"""Test 3: API: /v1/provide-actual-equipment-information-of-devices."""
...
class TestProvideActualEquipmentInformationOfDevices:
    """Test class for /v1/provide-actual-equipment-information-of-devices API."""

    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_returns_response_and_equipment_general_info_columns_exist(self):
        """Test that returns response and equipment_general_info columns exist."""
        test_file = __file__
        test_name = "test_returns_response_and_equipment_general_info_columns_exist"

        test_case = TEST_CASES["provideActualEquipmentInformationOfDevices"]
