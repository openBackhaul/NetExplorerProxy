"""Test 9: API: /v1/provide-list-of-interfaces-per-device-in-nep."""
...
class TestProvideListOfInterfacesPerDeviceInNep:
    """Test class for /v1/provide-list-of-interfaces-per-device-in-nep API."""

    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_returns_response_and_interfaces_per_device_columns_exist(self):
        """Test that returns response and interfaces per device columns exist."""
        test_file = __file__
        test_name = "test_returns_response_and_interfaces_per_device_columns_exist"

        test_case = TEST_CASES["provideInterfacesPerDevice"]
